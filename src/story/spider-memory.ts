...
export const spiderMemoryExperience: Experience = {
  ...
  assets: [
    ...
    { id: 'mj-conflicted', kind: 'figure', sourcePath: `${generated}/mj-conflicted-boundary-eye-fixed-v1.png`, sha256: '4bdf7138a57b4c59f3332edb30c1609aeff1ab54535b2750892af6c7792a7680', preparation: { ...normalize, matteCleanup: { spill: 'green', alphaFloor: 8, edgeAlphaCeiling: 249, channelMargin: 18 } } },
    { id: 'mj-trust', kind: 'figure', sourcePath: `${generated}/mj-reluctant-trust-eye-fixed-v1.png`, sha256: '3e28c985076cd51248e9b05094516e28fb31bf33196185c51ec342dd0837233b', preparation: { ...normalize, matteCleanup: { spill: 'green', alphaFloor: 8, edgeAlphaCeiling: 249, channelMargin: 18 } } },
  ...
  moments: [
    ...
    { id: 'unmask', chapter: 'Scene 16 · The Memory Between Us', tableauId: 'revealed-peter-active', viewpoint: { kind: 'public' }, mode: 'action', label: 'Revelation', text: 'He removed the mask. The hero did not leave; he became visibly human.', cueAssetIds: ['cloth-shift'], performanceBeat: { actorId: 'peter-parker', phase: 'decision', importance: 'pivotal' }, next: { type: 'goto', nodeId: 'name' } },
    ...
    { id: 'mj-sees', chapter: 'Scene 16 · The Memory Between Us', tableauId: 'revealed-mj-active', viewpoint: { kind: 'private', holderId: 'mj' }, mode: 'thought', speakerId: 'mj', text: 'His face carried the grief of recognition. Mine could only answer with sympathy.', cueAssetIds: [], performanceBeat: { actorId: 'mj', phase: 'appraisal', importance: 'pivotal' }, next: { type: 'goto', nodeId: 'mj-answer' } },
    { id: 'mj-answer', chapter: 'Scene 16 · The Memory Between Us', tableauId: 'revealed-mj-active', viewpoint: { kind: 'public' }, mode: 'dialogue', speakerId: 'mj', text: 'I can understand why the girl in your memories loved you. But I am standing here without them.', cueAssetIds: [], performanceBeat: { actorId: 'mj', phase: 'decision', importance: 'pivotal' }, next: { type: 'goto', nodeId: 'perspective-choice' } },
    ...
    { id: 'ride-home', chapter: 'Scene 16 · The Memory Between Us', tableauId: 'revealed-mj-trust', viewpoint: { kind: 'public' }, mode: 'dialogue', speakerId: 'mj', text: 'I still need to get home. Can you take me?', cueAssetIds: [], performanceBeat: { actorId: 'mj', phase: 'after-state', importance: 'pivotal' }, next: { type: 'goto', nodeId: 'ending' } },
