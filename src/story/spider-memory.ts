...
const authored: Experience = {
  ...
  readerInsights: [
    { id: 'threshold-distance-noticed', meaning: 'Peter keeps the exit available so MJ never has to move around him.' },
    { id: 'mj-grip-noticed', meaning: 'MJ holds her jacket seam as a private boundary she can release only by choice.' },
    { id: 'peter-restraint-understood', meaning: 'Peter recognizes that love cannot authorize another decision on MJ’s behalf.' },
    { id: 'mj-memory-boundary-understood', meaning: 'MJ can honour Peter’s sacrifice without inheriting the erased relationship.' },
  ],
  assets: [
  ...
  moments: [
    ...
    { id: 'mj-corrects-promise', chapter: 'Scene 16 · The Memory Between Us', tableauId: 'hallway-mj-active', viewpoint: { kind: 'public' }, mode: 'dialogue', speakerId: 'mj', text: 'Taking me home is not a promise about tomorrow. It is one walk, tonight.', cueAssetIds: [], next: { type: 'goto', nodeId: 'peter-hears-limit' } },
    ...
    { id: 'stairs-begin', chapter: 'Scene 16 · The Memory Between Us', tableauId: 'hallway-shared-distance', viewpoint: { kind: 'public' }, mode: 'action', label: 'A smaller beginning', text: 'MJ turned toward the stairwell. Peter waited for her first step, then matched neither her stride nor her silence—only the distance she had chosen.', cueAssetIds: ['distant-siren'], next: { type: 'goto', nodeId: 'ending' } },
