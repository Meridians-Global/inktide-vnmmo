...
const authored: Experience = {
  ...
  readerInsights: [
    { id: 'cat-reads-map', meaning: 'Vernon saw the cat reading a map before he saw it reading a sign; the impossible thing arrived first.' },
    { id: 'cat-reads-sign', meaning: 'Vernon let himself see only a cat looking at a street sign; the map was edited out.' },
    { id: 'potters-named', meaning: 'The whisperers named the Potters and their son Harry; Vernon recognised the name and refused it.' },
    { id: 'cloaks-noticed', meaning: 'Vernon fixed on the cloaks rather than the words, and so kept the news at arm’s length.' },
  ],
  assets: [
  ...
  moments: [
    ...
    { id: 'vernon-stops-name', chapter, tableauId: 'morning-vernon', viewpoint: { kind: 'private', holderId: 'vernon' }, mode: 'thought', speakerId: 'vernon', text: 'Potter. He stopped dead. Fear flooded him. Then he told himself Potter was not an unusual name, there were plenty of Potters, and he was not even sure the nephew was called Harry. It might have been Harvey. Or Harold.', cueAssetIds: [], performanceBeat: { actorId: 'vernon', phase: 'decision', importance: 'supporting' }, next: { type: 'goto', nodeId: 'vernon-returns' } },
    { id: 'vernon-stops-cloaks', chapter, tableauId: 'morning-vernon', viewpoint: { kind: 'private', holderId: 'vernon' }, mode: 'thought', speakerId: 'vernon', text: 'Cloaks. Emerald green, in the middle of the working day. He glared at them so hard that he nearly missed the word Potter altogether—and decided, on balance, that he had.', cueAssetIds: [], performanceBeat: { actorId: 'vernon', phase: 'decision', importance: 'supporting' }, next: { type: 'goto', nodeId: 'vernon-returns' } },
    ...
    { id: 'mcgonagall-private', chapter, tableauId: 'dark-mcgonagall-active', viewpoint: { kind: 'private', holderId: 'mcgonagall' }, mode: 'thought', speakerId: 'mcgonagall', text: 'Say it is a rumour. Say it. She had sat on a cold wall for a whole day so that she could hear him say it before anyone else did.', cueAssetIds: [], next: { type: 'goto', nodeId: 'dumbledore-confirms' } },
    ...
    { id: 'mcgonagall-breaks', chapter, tableauId: 'dark-mcgonagall-grief', viewpoint: { kind: 'public' }, mode: 'action', label: 'Grief', text: 'Professor McGonagall’s voice trembled. She had to sit for a moment. “That’s not all. They’re saying he tried to kill the Potters’ son, Harry. And that he couldn’t. That he couldn’t kill a little boy.”', cueAssetIds: [], performanceBeat: { actorId: 'mcgonagall', phase: 'after-state', importance: 'pivotal' }, next: { type: 'choice', posture: 'traversal', weight: 'texture', purpose: 'predict', prompt: 'Why could the most feared wizard in a century not kill a child?', options: [
      ...
      { id: 'his-power-broke', label: 'His own power turned on him', consequence: 'Predict that the curse failed at its source.', nodeId: 'dumbledore-guess' },
