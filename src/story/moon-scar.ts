...
const authored: Experience = {
  ...
  readerInsights: [
    { id: 'crescent-absence-noticed', standing: 'grounded', meaning: 'The three failed cores form a deliberate crescent rather than random loss.' },
    { id: 'chun-contact-distance-noticed', standing: 'grounded', meaning: 'Chun keeps her covered fingertips away from the sealed cores before explaining why.' },
    { id: 'fang-leverage-understood', standing: 'grounded', meaning: 'Fang values a repeatable learning material more than one successful refinement.' },
    { id: 'chun-warning-understood', standing: 'grounded', meaning: 'Chun treats discovery as evidence, not permission to continue.' },
    { id: 'secrecy-as-stake-assumed', standing: 'mistaken', meaning: 'You read the cellar as a question of who knows; the stone’s own behaviour went unasked.' },
    { id: 'chun-ambition-assumed', standing: 'mistaken', meaning: 'You read Chun’s distance and her grip on the key as a claim on the material.' },
    { id: 'fang-delegates-risk-assumed', standing: 'mistaken', meaning: 'You expected Fang to have Chun take the risk of the open seam for him.' },
    { id: 'haste-as-control-assumed', standing: 'mistaken', meaning: 'You took speed for control: repeat the trial tonight, while the seam still answers.' },
  ],
  assets: [
    ...
    { id: 'fang-seal-order', kind: 'figure', sourcePath: `${generated}/fang-seal-order-v1.png`, sha256: '518952bef361a34c87fcfd618880749d559771383bf89672da6918dd172c2cff', preparation: { ...normalize, matteCleanup: { spill: 'green', alphaFloor: 8, edgeAlphaCeiling: 249, channelMargin: 18 } } },
  ...
  actors: [
    { id: 'fang-yuan', name: 'Fang Yuan', identityVersion: 'fang-yuan-v2', defaultAppearanceId: 'field-neutral', stageHeightPercent: 88, appearances: [
      ...
      { id: 'seal-order', assetId: 'fang-seal-order', stageName: 'Fang Yuan', wardrobe: 'black-grey-field-robes', expression: 'order-given', concealment: 'civilian', projection: 'three-quarter', sourceFacing: 'right' },
    ] },
  ...
  tableaux: [
    ...
    {
      id: 'moon-scar-seal-order', location: 'Gu Yue Clan · Chun’s Cellar', backgroundAssetId: 'cellar-bg', ambienceAssetId: 'interior-room', musicAssetId: 'moon-scar-revelation', shot: 'artifact', tone: 'ominous', figures: [
        { actorId: 'fang-yuan', appearanceId: 'seal-order', slot: 'far-left', facing: 'right', emphasis: 'active' },
        { actorId: 'gu-yue-chun', appearanceId: 'held-warning', slot: 'far-right', facing: 'left', emphasis: 'supporting' },
      ], artifact: { assetId: 'moon-scar-gu', slot: 'center', footprint: 'large' },
    },
    {
  ...
  moments: [
    ...
    { id: 'question-choice', chapter: 'Chapter 11 · The Result', tableauId: 'fang-question', viewpoint: { kind: 'private', holderId: 'fang-yuan' }, mode: 'thought', speakerId: 'fang-yuan', text: 'The number was bait. The useful question was what Chun had chosen not to measure.', cueAssetIds: [], performanceBeat: { actorId: 'fang-yuan', phase: 'decision', importance: 'pivotal' }, next: { type: 'choice', posture: 'traversal', weight: 'texture', purpose: 'interpret', prompt: 'Which accepted passage do you read?', options: [
      ...
      { id: 'ask-witnesses', label: 'Ask who else has counted these cores.', consequence: 'Tests the secrecy.', nodeId: 'witness-question', distractor: true, grantsInsightIds: ['secrecy-as-stake-assumed'] },
    ] } },
    { id: 'witness-question', chapter: 'Chapter 11 · The Result', tableauId: 'fang-question', viewpoint: { kind: 'public' }, mode: 'dialogue', speakerId: 'fang-yuan', text: 'Who else has counted these?', cueAssetIds: [], next: { type: 'goto', nodeId: 'witness-chun-private' } },
    { id: 'witness-chun-private', chapter: 'Chapter 11 · The Result', tableauId: 'cellar-conversation', viewpoint: { kind: 'private', holderId: 'gu-yue-chun' }, mode: 'thought', speakerId: 'gu-yue-chun', text: 'He asked about witnesses before he asked about the stone. Secrecy was the smaller danger in this room, and he had reached for it first.', cueAssetIds: [], next: { type: 'goto', nodeId: 'chun-answers' } },
    ...
    { id: 'chun-answers', chapter: 'Chapter 11 · The Result', tableauId: 'cellar-disclosure', viewpoint: { kind: 'public' }, mode: 'dialogue', speakerId: 'gu-yue-chun', text: 'Neither. The moss was not consumed. It was teaching the stone to remember moonlight.', readingVariants: [
      ...
      { when: { kind: 'active-choice', choiceNodeId: 'question-choice', optionId: 'ask-witnesses' }, text: 'No one. That is not the result either. The moss was not consumed. It was teaching the stone to remember moonlight.' },
    ...
    { id: 'reliquary-reading-choice', chapter: 'Chapter 11 · The Result', tableauId: 'substrate-study', viewpoint: { kind: 'public' }, mode: 'narration', label: 'Reading', text: 'The same result offered leverage to one witness and warning to the other.', cueAssetIds: [], next: { type: 'choice', posture: 'traversal', weight: 'texture', purpose: 'interpret', prompt: 'Whose reading do you carry into the reveal?', options: [
      ...
      { id: 'read-chun-claim', label: 'Gu Yue Chun · claim', consequence: 'Read the finder’s distance as a finder’s grip.', nodeId: 'chun-claim-reading', distractor: true, grantsInsightIds: ['chun-ambition-assumed'] },
    ] } },
    { id: 'chun-claim-reading', chapter: 'Chapter 11 · The Result', tableauId: 'substrate-chun-appraisal', viewpoint: { kind: 'public' }, mode: 'narration', label: 'Reading', text: 'You read her caution as a claim: the one who found it keeps it. The reading fitted the sleeve, the sealed room, and the key she had not yet mentioned.', cueAssetIds: [], next: { type: 'goto', nodeId: 'moon-scar' } },
    ...
    { id: 'chun-hesitates', chapter: 'Chapter 11 · The Result', tableauId: 'moon-scar-aftermath', viewpoint: { kind: 'public' }, mode: 'action', label: 'Aftermath', text: 'Chun’s hand hovered above the seam. She had brought him a result; the distance she kept from it made the result a warning.', readingVariants: [
      { when: { kind: 'reader-insights', insightIds: ['secrecy-as-stake-assumed'] }, text: 'Chun’s hand hovered above the seam. She had hidden this from no one; she had kept it from herself. The distance, not the secrecy, made the result a warning.' },
    ], cueAssetIds: [], next: { type: 'goto', nodeId: 'fang-conduct-forecast' } },
    { id: 'fang-conduct-forecast', chapter: 'Chapter 11 · The Result', tableauId: 'moon-scar-reflection', viewpoint: { kind: 'public' }, mode: 'narration', label: 'Your reading', text: 'The seam would not remain open. Fang Yuan had time for one revealing movement.', cueAssetIds: [], next: { type: 'choice', posture: 'traversal', weight: 'texture', purpose: 'predict', prompt: 'What do you expect him to do?', options: [
      ...
      { id: 'expect-delegate', label: 'Have Chun touch it first', consequence: 'Test whether he spends another hand before his own.', nodeId: 'forecast-delegate', distractor: true, grantsInsightIds: ['fang-delegates-risk-assumed'] },
    ] } },
    { id: 'forecast-delegate', chapter: 'Chapter 11 · The Result', tableauId: 'moon-scar-reflection', viewpoint: { kind: 'public' }, mode: 'narration', label: 'Prediction', text: 'You expected him to let the finder take the finder’s risk, and to learn from whatever it cost her.', cueAssetIds: [], next: { type: 'goto', nodeId: 'fang-does-not-touch' } },
    ...
    { id: 'conduct-prediction-settles', chapter: 'Chapter 11 · The Result', tableauId: 'moon-scar-restraint', viewpoint: { kind: 'public' }, mode: 'narration', label: 'Prediction answered', text: 'The untouched seam made patience visible as a form of control.', readingVariants: [
      ...
      { when: { kind: 'active-choice', choiceNodeId: 'fang-conduct-forecast', optionId: 'expect-delegate' }, text: 'You had expected Fang to spend Chun’s hand. He spent no one’s. The untouched seam made patience visible as a form of control.' },
    ...
    { id: 'trial-decision', chapter: 'Chapter 11 · The Result', tableauId: 'moon-scar-reflection', viewpoint: { kind: 'public' }, mode: 'narration', label: 'Decision', text: 'Preserving the discovery was not enough. Tomorrow’s trial needed a constraint that would survive the appetite of whoever ordered it.', cueAssetIds: [], next: { type: 'choice', posture: 'traversal', weight: 'texture', purpose: 'decide', prompt: 'Which safeguard must the order make concrete?', options: [
      ...
      { id: 'choose-repeat-tonight', label: 'Repeat the trial tonight', consequence: 'Use the open seam while it still answers, before anyone else can.', nodeId: 'repeat-tonight-reading', distractor: true, grantsInsightIds: ['haste-as-control-assumed'] },
    ] } },
    { id: 'repeat-tonight-reading', chapter: 'Chapter 11 · The Result', tableauId: 'moon-scar-reflection', viewpoint: { kind: 'public' }, mode: 'narration', label: 'Decision', text: 'You wanted the trial tonight, while the seam still answered. Fang Yuan’s order went the other way.', cueAssetIds: [], next: { type: 'goto', nodeId: 'seal-order' } },
    ...
    { id: 'seal-order', chapter: 'Chapter 11 · The Result', tableauId: 'moon-scar-seal-order', viewpoint: { kind: 'public' }, mode: 'dialogue', speakerId: 'fang-yuan', text: 'Seal the original. You keep the key. Tomorrow, show me the first failed core—and we work from a copy.', readingVariants: [
      ...
      { when: { kind: 'active-choice', choiceNodeId: 'trial-decision', optionId: 'choose-repeat-tonight' }, text: '“Seal the original,” Fang said. “Not tonight. You keep the key. Tomorrow, show me the first failed core—and we work from a copy.”' },
    ], performanceBeat: { actorId: 'fang-yuan', phase: 'after-state', importance: 'pivotal' }, cueAssetIds: ['seal-stone'], next: { type: 'goto', nodeId: 'chun-tests-order' } },
    ...
    { id: 'fang-answers-cost', chapter: 'Chapter 11 · The Result', tableauId: 'moon-scar-reflection', viewpoint: { kind: 'public' }, mode: 'dialogue', speakerId: 'fang-yuan', text: 'Then the difference becomes the result. We record it before we use it.', readingVariants: [
      { when: { kind: 'reader-insights', insightIds: ['haste-as-control-assumed'] }, text: 'Then the difference becomes the result. We record it before we use it. Tonight would only have recorded our appetite.' },
    ], cueAssetIds: [], next: { type: 'goto', nodeId: 'scar-closes' } },
    { id: 'scar-closes', chapter: 'Chapter 11 · The Result', tableauId: 'substrate-held-warning', viewpoint: { kind: 'public' }, mode: 'action', label: 'Seal', text: 'Chun lowered the mineral lid. Violet light narrowed to a thread, then vanished beneath blank paper and dark stone.', readingVariants: [
      { when: { kind: 'reader-insights', insightIds: ['fang-delegates-risk-assumed'] }, text: 'Chun lowered the mineral lid herself; he had not asked her to. Violet light narrowed to a thread, then vanished beneath blank paper and dark stone.' },
    ], cueAssetIds: ['stone-collection'], next: { type: 'goto', nodeId: 'key-remains' } },
    { id: 'key-remains', chapter: 'Chapter 11 · The Result', tableauId: 'cellar-disclosure', viewpoint: { kind: 'public' }, mode: 'action', label: 'Custody', text: 'The key disappeared into Chun’s sleeve. Fang watched the motion and did not ask for it.', readingVariants: [
      { when: { kind: 'reader-insights', insightIds: ['chun-ambition-assumed'] }, text: 'The key disappeared into Chun’s sleeve. Whatever you had taken for a claim, she had kept the key so that no one—herself included—could reach the stone alone. Fang watched the motion and did not ask for it.' },
    ], cueAssetIds: ['cloth-shift'], next: { type: 'goto', nodeId: 'ending' } },
