...
const privetManifest: AcquisitionManifest = {
  ...
  requests: [
    ...
    rendition(privetStyle, 'mcgonagall-questioning-v1', `${privetSprites}/mcgonagall-stern-v1.png`, MAGENTA,
      'appraisal. Her arms have come unfolded: she leans very slightly forward, one hand half-raised with the fingers open as she presses a question, eyes searching and urgent behind the square spectacles, lips parted. Indignation giving way to the need to know.'),
